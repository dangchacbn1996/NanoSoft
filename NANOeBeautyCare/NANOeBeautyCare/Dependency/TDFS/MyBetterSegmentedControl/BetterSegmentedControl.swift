...
@IBDesignable open class BetterSegmentedControl: UIControl {
    open class IndicatorView: UIView {
        ...
        fileprivate var cornerRadiusLocal: CGFloat = 6.0 {
            didSet {
                layer.cornerRadius = cornerRadiusLocal
                segmentMaskView.layer.cornerRadius = cornerRadiusLocal
            }
        }
    ...
    @IBInspectable public var cornerRadiusLocal: CGFloat {
        get {
    ...
    private func updateCornerRadii() {
        indicatorView.cornerRadiusLocal = cornerRadiusLocal - indicatorViewInset
        segmentViews.forEach { $0.layer.cornerRadius = indicatorView.cornerRadiusLocal }
    }
