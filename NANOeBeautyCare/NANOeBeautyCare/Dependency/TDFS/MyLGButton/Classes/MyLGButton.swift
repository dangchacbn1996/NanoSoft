...
@IBDesignable
open class MyLGButton: UIControl {
    ...
    @IBInspectable public var borderColors: UIColor = UIColor.white {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var borderWidths: CGFloat = 0.0 {
        didSet{
            setupView()
        }
    }
    ...
    @IBInspectable public var shadowOffsets: CGSize = CGSize.init(width:0, height:0) {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var shadowRadiuss: CGFloat = 0 {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var shadowOpacitys: CGFloat = 1 {
        didSet{
            setupView()
        }
    }
    
    @IBInspectable public var shadowColors: UIColor = UIColor.black {
        didSet{
            setupView()
        }
    }
    ...
    fileprivate func setupBackgroundColor() {
        bgContentWidthConstraint.constant = min(0, -borderWidths)
        bgContentHeightConstraint.constant = min(0, -borderWidths)
    ...
    fileprivate func setupBorderAndCorners() {
        if fullyRoundedCorners {
            ...
            bgContentView.layer.cornerRadius = cornerRadiuss
    ...
    fileprivate func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "MyLGButton", bundle: bundle)
