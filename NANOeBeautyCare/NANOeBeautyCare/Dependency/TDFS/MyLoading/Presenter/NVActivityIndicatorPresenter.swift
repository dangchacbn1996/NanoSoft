...
public final class NVActivityIndicatorPresenter {
    ...
    fileprivate func show(with activityData: ActivityData, _ fadeInAnimation: FadeInAnimation?) {
        ...
        let activityIndicatorView = NVActivityIndicatorView(
            frame: CGRect(x: 0, y: 0, width: 80.0, height: 80.0),
...
//        let viewsss = UIView(frame: CGRect(x: 30.0, y: 30.0, width: 20.0, height: 20.0))
//        viewsss.backgroundColor = . red
        let images = UIImageView(frame: CGRect(x: 15.0, y: 15.0, width: 50.0, height: 50.0))
        images.image = activityData.icon
        activityIndicatorView.addSubview(images)
