...
@IBDesignable public class ScrollPager: UIView, UIScrollViewDelegate{
    ...
    @IBInspectable public var borderColorsss: UIColor? {
        didSet { self.layer.borderColor = borderColorsss?.cgColor }
    }

    @IBInspectable public var borderWidthsss: CGFloat = 0 {
        didSet { self.layer.borderWidth = borderWidthsss }
    }
