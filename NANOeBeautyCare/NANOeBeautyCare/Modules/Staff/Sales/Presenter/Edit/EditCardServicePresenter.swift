//
//  EditCardServicePresenter.swift
//  NANOeBeautyCare
//
...
protocol EditCardServiceVC: BaseView {
...
class EditCardServicePresenter: BasePresenter<EditCardServiceVC> {
    private let service = EditCardServiceService()
