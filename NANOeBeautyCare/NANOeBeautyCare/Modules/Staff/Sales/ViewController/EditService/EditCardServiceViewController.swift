//
//  EditCardServiceViewController.swift
//  NANOeBeautyCare
//
...
class EditCardServiceViewController: BaseViewController<EditCardServicePresenter> {
    // MARK: - IBOutlet
    ...
    override func initPresenter(with context: RouteContext?) {
        presenter = EditCardServicePresenter()
    ...
    override func viewDidLoad() {
        ...
        self.title = "Navigation.EditCardService".localized
...
extension EditCardServiceViewController: EditCardServiceVC {
...
extension EditCardServiceViewController: UITextFieldDelegate {
