//
//  EditProductServiceViewController.swift
//  NANOeBeautyCare
//
...
class EditProductServiceViewController: BaseViewController<EditProductServicePresenter> {
    ...
    @IBOutlet weak var unitTextfield: MyTextField!
    @IBOutlet weak var inStockTextfield: MyTextField!
    ...
    override func initPresenter(with context: RouteContext?) {
        presenter = EditProductServicePresenter()
    ...
    override func viewDidLoad() {
        ...
        self.title = "Navigation.EditProductService".localized
    ...
    @IBAction func unitButtonAction(_ sender: Any) {
        CommonView.alertUnitCatalog { (selected) in
            self.unitTextfield.text = selected.tenChoose
            self.inStockTextfield.text = "\(selected.soLuongChoose ?? 0)"
        }
...
extension EditProductServiceViewController: EditProductServiceVC {
    ...
    func updateFirstUnit(model: CheckProductOptionalResponse) {
        self.inStockTextfield.text = "\(model.soLuongTonMin ?? 0)"
        self.unitTextfield.text = model.tenDonViMin
    }
    ...
    func initData(data: ListService) {
        ...
        self.unitTextfield.text = data.tenDonVi
        self.inStockTextfield.text = "\(data.donvi ?? 0)"
...
extension EditProductServiceViewController: UITextFieldDelegate {
