//
//  DetailAppointmentOptionalResponse.swift
//  NANOeBeautyCare
//
...
// MARK: - DetailAppointmentOptionalResponse
struct DetailAppointmentOptionalResponse: Codable {
    var code: Int?
    var msg: String?
    var idLichHen: Int?
