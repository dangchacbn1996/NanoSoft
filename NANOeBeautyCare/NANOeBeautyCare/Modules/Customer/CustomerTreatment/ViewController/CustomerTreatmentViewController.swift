//
//  CustomerTreatmentViewController.swift
//  NANOeBeautyCare
//
...
class CustomerTreatmentViewController: BaseViewController<CustomerTreatmentPresenter> {
    // MARK: - IBOutlet
    
    
    // MARK: - Connect Presenter
    override func initPresenter(with context: RouteContext?) {
        presenter = CustomerTreatmentPresenter()
...
//        self.presenter?.updateBackContextData(context: context)
    ...
    func updateData(data: ViewCustomerTreatment) {
...
extension CustomerTreatmentViewController: CustomerTreatmentVC {
